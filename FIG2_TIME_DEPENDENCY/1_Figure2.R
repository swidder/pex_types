...
write.xlsx2(dat,"source_data_figure2.xlsx",sheetName = "figure2_A_B")
df5<-otu_table(prune_samples(sample_names(EC880)%in%rownames(dat), EC880))
df5<-df5[rowSums(df5)>0,]
write.xlsx2(df5,"source_data_figure2.xlsx",sheetName = "figure2_C", append=TRUE)
df4<-tax_table(EC880)[rownames(test),]
write.xlsx2(df4,"source_data_figure2.xlsx",sheetName = "figure2_C2", append=TRUE)
...
#Turnover numerical results
##PAT
#PEx
#lm(formula = sP$AI ~ sP$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept)  27.6128     0.4358  63.369  < 2e-16 ***
#sP$delta      0.1650     0.0358   4.609 4.46e-06 ***
#baseline
#lm(formula = sB$AI ~ sB$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 27.74297    0.24774  111.98   <2e-16 ***
#sB$delta     0.25860    0.02264   11.42   <2e-16 ***
##AN1
#PEx
#lm(formula = sP$AI ~ sP$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 28.46851    0.36359   78.30   <2e-16 ***
#sP$delta     0.40961    0.02976   13.76   <2e-16 ***
#baseline
#lm(formula = sB$AI ~ sB$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 28.20482    0.22990  122.69   <2e-16 ***
#sB$delta     0.33632    0.02107   15.96   <2e-16 ***
##AN2
#PEx
#lm(formula = sP$AI ~ sP$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 40.60462    0.46227  87.837   <2e-16 ***
#sP$delta     0.37925    0.03813   9.945   <2e-16 ***
# baseline
#lm(formula = sB$AI ~ sB$delta)
#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 39.43850    0.27665 142.556   <2e-16 ***
#sB$delta     0.24583    0.02551   9.637   <2e-16 ***
...
as.factor(D23) 2.1121  2.1121     1 279.17  10.605 0.001267 **
...
Type III Analysis of Variance Table with Satterthwaite's method
                    Sum Sq Mean Sq NumDF  DenDF F value  Pr(>F)  
as.numeric(classN) 0.18786 0.18786     1 249.07  4.0213 0.04601 *
...
Type III Analysis of Variance Table with Satterthwaite's method
                Sum Sq Mean Sq NumDF  DenDF F value  Pr(>F)  
as.factor(D23) 0.37672 0.37672     1 243.68  4.4118 0.03672 *
