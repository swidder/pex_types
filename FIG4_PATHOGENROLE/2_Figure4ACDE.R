...
#######################
## TOPOLOGY of AEROBICITY GROUPS
## FIG4A
###############

#harmonize order, color, etc.
#subset core ASVs 
orgs<-unique(ASV$ASV)
col<-rownames(TAX)
...
#relabel subjects for color code
tmp[tmp$patient=="patient1","patient"]<-"A"
tmp[tmp$patient=="patient12","patient"]<-"B"
tmp[tmp$patient=="patient13","patient"]<-"C"
tmp[tmp$patient=="patient14","patient"]<-"D"
tmp[tmp$patient=="patient17","patient"]<-"E"
tmp[tmp$patient=="patient20","patient"]<-"F"
tmp[tmp$patient=="patient30","patient"]<-"G"
tmp[tmp$patient=="patient5","patient"]<-"I"
tmp[tmp$patient=="patient6","patient"]<-"J"
tmp[tmp$patient=="patient9","patient"]<-"K"
tmp$patient<-factor(tmp$patient)
...
#########
#KOLMOGOROV SMIRNOV TEST for similarity of cumulative distributions
###########
